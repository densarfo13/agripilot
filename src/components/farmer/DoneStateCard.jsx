...
const S = {
  ...
  title: { fontSize: '1.375rem', fontWeight: 700, margin: 0, color: '#C8944D' },
  ...
  barFill: { height: '100%', background: '#C8944D', transition: 'width 0.3s ease' },
  tomorrow: {
    marginTop: '0.5rem',
    fontSize: '0.8125rem',
  ...
  nextBtn: {
    ...
    background: '#C8944D', color: '#07210E',
