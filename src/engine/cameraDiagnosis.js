...
const ACTIONS = {
  [DIAGNOSIS_CATEGORY.PEST_DETECTED]: {
    issueType: 'pest_detected',
    titleKey: 'camera.action.pest.title',
    whyKey: 'camera.action.pest.why',
    lookForKey: 'camera.action.pest.lookFor',   // pipe-separated items
    stepsKey: 'camera.action.pest.steps',
    tipKey: 'camera.action.pest.tip',
    primaryCtaKey: 'camera.cta.addToToday',
    followupTaskType: 'pest_recheck',
    urgency: 'today',
    priority: 'high',
    icon: '\uD83D\uDC1B',
  ...
  [DIAGNOSIS_CATEGORY.LEAF_DAMAGE]: {
    issueType: 'leaf_damage',
    titleKey: 'camera.action.leaf.title',
    whyKey: 'camera.action.leaf.why',
    lookForKey: 'camera.action.leaf.lookFor',
    stepsKey: 'camera.action.leaf.steps',
    tipKey: 'camera.action.leaf.tip',
    primaryCtaKey: 'camera.cta.addToToday',
    followupTaskType: 'leaf_recheck',
    urgency: 'today',
    priority: 'high',
    icon: '\uD83C\uDF42',
  ...
  [DIAGNOSIS_CATEGORY.DISCOLORATION]: {
    ...
    lookForKey: 'camera.action.color.lookFor',
    stepsKey: 'camera.action.color.steps',
    tipKey: 'camera.action.color.tip',
    primaryCtaKey: 'camera.cta.addToToday',
    followupTaskType: 'color_recheck',
    urgency: 'today',
    priority: 'medium',
    icon: '\uD83D\uDCA7',
  ...
  [DIAGNOSIS_CATEGORY.UNKNOWN_ISSUE]: {
    ...
    lookForKey: 'camera.action.unknown.lookFor',
    stepsKey: 'camera.action.unknown.steps',
    tipKey: 'camera.action.unknown.tip',
    primaryCtaKey: 'camera.cta.addToToday',
    followupTaskType: 'general_recheck',
    urgency: 'this_week',
    priority: 'medium',
    icon: '\uD83D\uDD0D',
  ...
  [DIAGNOSIS_CATEGORY.NO_ISSUE_DETECTED]: {
    issueType: 'no_issue_detected',
    titleKey: 'camera.action.healthy.title',
    whyKey: 'camera.action.healthy.why',
    lookForKey: 'camera.action.healthy.lookFor', // reused as "what to do" items
    stepsKey: null,
    tipKey: 'camera.action.healthy.tip',
    primaryCtaKey: 'camera.cta.continueCare',
...
export const SCAN_FAILED_ACTION = {
  ...
  tipKey: null,
  primaryCtaKey: 'camera.cta.scanAgain',
  followupTaskType: null,
  urgency: 'this_week',
  priority: 'medium',
  icon: '\u26A0\uFE0F',
