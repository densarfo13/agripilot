...
export const FARROWAY_BUILD_VERSION = 'routing-fix-no-setup-redirect-v1';
...
export const FARROWAY_UI_VERSION = 'routing-fix-no-setup-redirect-v1';
...
export const FARROWAY_BUILD_SEQUENCE = 39;
