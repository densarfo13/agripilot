...
export const FARROWAY_BUILD_VERSION = 'restored-stable-pilot-v1';
...
export const FARROWAY_UI_VERSION = 'restored-stable-pilot-v1';
...
export const FARROWAY_BUILD_SEQUENCE = 28;
