...
export const DEFAULT_SETTINGS = Object.freeze({
  dailyReminderEnabled:    true,
  // Spec §1: default 7 AM local time.
  dailyReminderTime:       '07:00',
  // Spec §1 / §5: push default OFF — browser permission is requested
  // only after meaningful engagement (farm_created, task_completed).
  // The send path still requires BOTH browserPushEnabled===true AND
  // Notification.permission==='granted' before dispatching, so
  // flipping this to true later never causes a surprise prompt.
  browserPushEnabled:      false,
