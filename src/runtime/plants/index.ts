...
// TDZ / circular-import fix — plantsForBriefing now lives in its own
// leaf module (plantsBriefing.ts) so briefingComposer can import it
// WITHOUT importing this barrel back (which created the
// index ⇄ briefingComposer cycle). We import + re-export it here.
import { plantsForBriefing, PLANTS_BRIEFING_VERSION } from './plantsBriefing';

export const UNIVERSAL_PLANT_RUNTIME_VERSION = 'universal-plant-runtime-v1';
export { plantsForBriefing, PLANTS_BRIEFING_VERSION };
...
// plantsForBriefing() moved to ./plantsBriefing (imported + re-exported
// above) to break the index ⇄ briefingComposer circular import.
