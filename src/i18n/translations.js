...
const T = {
  ...
  'camera.action.pest.lookFor': { en: 'Small holes in leaves | Insects under leaves | Chewed or damaged edges', fr: 'Petits trous dans les feuilles | Insectes sous les feuilles | Bords mâchés ou abîmés', sw: 'Matundu madogo kwenye majani | Wadudu chini ya majani | Kingo zilizotafunwa', ha: 'Ƙananan ramuka a ganyaye | Kwari a ƙarƙashin ganyaye | Gefen da aka cije ko lalata', tw: 'Ntokuro nketewa wɔ nhaban mu | Mmoawa wɔ nhaban ase | Afaafaa a wɔawe anaa asɛe' },
  'camera.action.leaf.lookFor': { en: 'Torn or dry leaves | Damaged leaf edges | Leaves with visible spots', fr: 'Feuilles déchirées ou sèches | Bords abîmés | Feuilles tachées', sw: 'Majani yaliyopasuka au kavu | Kingo zilizoharibika | Majani yenye madoa', ha: 'Ganyaye masu yagewa ko bushewa | Gefen da suka lalace | Ganyaye masu tabo', tw: 'Nhaban a atete anaa awoɔ | Nhaban afaafaa a asɛe | Nhaban a ɛwɔ adwamma' },
  'camera.action.color.lookFor': { en: 'Yellow leaves | Pale green leaves | Uneven color across the plant', fr: 'Feuilles jaunes | Feuilles vert pâle | Couleur inégale sur la plante', sw: 'Majani ya manjano | Majani ya kijani hafifu | Rangi isiyo sawa kwenye mmea', ha: 'Ganyaye masu rawaya | Ganyaye kore mai launi mara ƙarfi | Launi daban-daban a shukar', tw: 'Nhaban a ayɛ akokɔsrade | Nhaban a nsɛso asɛe | Kɔlɔ ahoroɔ a ɛnyɛ pɛ' },
  'camera.action.unknown.lookFor': { en: 'Unusual leaf color | Spots or marks on leaves | Weak or drooping stems', fr: 'Couleur inhabituelle | Taches ou marques | Tiges faibles ou affaissées', sw: 'Rangi isiyo ya kawaida | Madoa au alama | Mashina dhaifu au yanayoinama', ha: 'Launin ganye na daban | Tabo ko alamomi | Kara masu rauni ko masu lankwasawa', tw: 'Nhaban kɔlɔ a ɛnyɛ daa deɛ | Adwamma wɔ nhaban so | Dua a ayɛ mmerɛw anaa akotow' },
  'camera.action.healthy.lookFor': { en: 'Water as needed | Check your plants again tomorrow | Watch for early changes', fr: 'Arroser si besoin | Vérifier vos plants demain | Surveiller les premiers changements', sw: 'Mwagilia inapohitajika | Kagua mimea yako kesho | Angalia mabadiliko ya mapema', ha: 'Shayar idan ana buƙata | Duba shuke-shuke gobe | Lura da canji da wuri', tw: 'Gu nsu sɛ ɛhia | San hwɛ wo nnua no ɔkyena | Hwɛ nsakraeɛ a ɛdi kan' },

  // ─── Camera: tips (one line each) ────────────────────────
  'camera.action.pest.tip': { en: 'Check early in the morning — pests are easier to spot', fr: 'Vérifier tôt le matin — les ravageurs sont plus visibles', sw: 'Kagua asubuhi mapema — wadudu wanaonekana rahisi', ha: 'Duba da safe — kwari sun fi bayyana', tw: 'Hwɛ anɔpa — mmoawa da adi kɛse' },
  ...
  'camera.action.healthy.tip': { en: 'Healthy crops still need daily attention to stay strong', fr: 'Un bon soin quotidien garde la culture solide', sw: 'Zao lenye afya bado linahitaji utunzaji wa kila siku', ha: 'Amfani mai lafiya na buƙatar kulawa ta kullum', tw: 'Nnɔbae a ɛwɔ apɔmuden hia daa nhwɛsoɔ' },
  ...
  'camera.followup.why': { en: 'A possible issue was detected yesterday', fr: 'Un problème possible a été détecté hier', sw: 'Tatizo liliwezekana likagundulika jana', ha: 'Wata matsala mai yiwuwa an gano jiya', tw: 'Ɛda baako ɛnnera, yɛhunuu biribi' },
  ...
  'camera.followup.steps': { en: 'Inspect the same plants again | Remove any pests found | Watch for further changes', fr: 'Inspecter les mêmes plants | Retirer les ravageurs trouvés | Surveiller d\'autres changements', sw: 'Kagua mimea ileile tena | Ondoa wadudu utaokutana nao | Angalia mabadiliko zaidi', ha: 'Sake duba shuke-shuken nan | Cire kwari da ka gani | Lura da ƙarin canje-canje', tw: 'San hwɛ nnua korɔ no | Yi mmoawa biara a wobɛhunu | Hwɛ nsakraeɛ foforɔ' },
