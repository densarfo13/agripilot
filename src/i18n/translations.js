...
const T = {
  ...
  // ─── Funding Opportunities Layer (v3 merge) ────────────────
  ...
  'funding.source':             { en: 'Source',              fr: 'Source',             sw: 'Chanzo',            ha: 'Tushe',                tw: 'Nipa a wɔde maaeɛ', hi: 'स्रोत' },
  ...
  'funding.viewOpportunities':  { en: 'View Opportunities',  fr: 'Voir les opportunités', sw: 'Tazama Fursa',       ha: 'Duba Dama',             tw: 'Hwɛ Hokwan',         hi: 'अवसर देखें' },
  'funding.adminTitle':         { en: 'Funding opportunities — manage', fr: 'Opportunités de financement — gérer', sw: 'Fursa za ufadhili — simamia', ha: 'Damar tallafi — gudanar', tw: 'Sika hokwan — hwɛ so',  hi: 'फंडिंग अवसर — प्रबंधन' },
  'funding.adminLead':          { en: 'Curate the funding & support catalog.', fr: 'Gérer le catalogue de financement et de soutien.', sw: 'Simamia katalogi ya fedha na msaada.', ha: 'Sarrafa kasidu na tallafi.', tw: 'Hwɛ sika ne mmoa nhyehyɛeɛ.', hi: 'फंडिंग और सहायता सूची प्रबंधित करें।' },
  'funding.adminEmpty':         { en: 'No opportunities yet', fr: 'Aucune opportunité pour l\'instant', sw: 'Hakuna fursa bado', ha: 'Babu dama tukuna',  tw: 'Hokwan biara nni hɔ',   hi: 'अभी कोई अवसर नहीं' },
  'funding.adminEmptyHint':     { en: 'Create the first opportunity using the button above.', fr: 'Créez la première opportunité avec le bouton ci-dessus.', sw: 'Tengeneza fursa ya kwanza kwa kutumia kitufe hapo juu.', ha: 'Ƙirƙiri damar farko ta hanyar amfani da maɓallin da ke sama.', tw: 'Yɛ hokwan a edi kan no fa abɔdoo a ɛwɔ atifi no so.', hi: 'ऊपर दिए बटन से पहला अवसर बनाएँ।' },
  'funding.adminNew':           { en: 'New opportunity',     fr: 'Nouvelle opportunité', sw: 'Fursa Mpya',          ha: 'Sabuwar dama',          tw: 'Hokwan foforɔ',      hi: 'नया अवसर' },

  // NGO dashboard panel labels
  'funding.ngoPanelTitle':      { en: 'Funding opportunities', fr: 'Opportunités de financement', sw: 'Fursa za ufadhili',  ha: 'Damar tallafi',       tw: 'Sika hokwan',         hi: 'फंडिंग अवसर' },
  'funding.ngoPanelLead':       { en: 'Programs surfaced to your farmers', fr: 'Programmes proposés à vos agriculteurs', sw: 'Mipango inayoonyeshwa kwa wakulima wako', ha: 'Shirye-shiryen da ake nuna wa manomanka', tw: 'Nhyehyɛeɛ a yɛkyerɛ wo akuafoɔ', hi: 'आपके किसानों को दिखाए गए कार्यक्रम' },
  'funding.activeCount':        { en: 'Active opportunities', fr: 'Opportunités actives', sw: 'Fursa hai',          ha: 'Damar masu aiki',     tw: 'Hokwan a ɛrekɔ so',  hi: 'सक्रिय अवसर' },
  'funding.deadlinesSoon':      { en: 'Deadlines in 30 days', fr: 'Échéances dans 30 jours', sw: 'Tarehe za mwisho ndani ya siku 30', ha: 'Ƙarshen lokaci a cikin kwana 30', tw: 'Da Korkorɛɛ wɔ nna 30 mu', hi: '30 दिनों में समय सीमा' },
  'funding.deadlinesSoonLabel': { en: 'Closing soon — share with farmers now', fr: 'Bientôt clos — partagez avec les agriculteurs maintenant', sw: 'Inafungwa hivi karibuni — shiriki na wakulima sasa', ha: 'Yana rufewa nan ba da daɗewa ba — raba wa manoma yanzu', tw: 'Ɛrebɛto mu — kyɛ akuafoɔ no seesei', hi: 'जल्द बंद हो रहा — किसानों को अभी साझा करें' },
  'funding.matchedFarmers':     { en: 'Matched farmers',     fr: 'Agriculteurs correspondants', sw: 'Wakulima waliolingana', ha: 'Manomi da suka dace', tw: 'Akuafoɔ a wɔfata',   hi: 'मिलान किए किसान' },
  'funding.shareWithFarmers':   { en: 'Share with farmers',  fr: 'Partager avec les agriculteurs', sw: 'Shiriki na wakulima', ha: 'Raba wa manoma',     tw: 'Kyɛ akuafoɔ no',     hi: 'किसानों के साथ साझा करें' },
  'funding.exportList':         { en: 'Export list',         fr: 'Exporter la liste',   sw: 'Hamisha orodha',     ha: 'Fitar da jeri',         tw: 'Yi adi',             hi: 'सूची निर्यात करें' },
  'funding.manage':             { en: 'Manage opportunities', fr: 'Gérer les opportunités', sw: 'Simamia fursa',     ha: 'Gudanar da dama',       tw: 'Hwɛ hokwan no so',   hi: 'अवसरों का प्रबंधन' },
  'funding.ngoPanelHonesty':    { en: 'Only active + verified entries surface to farmers. Sample / draft entries are excluded from the CSV export.', fr: 'Seules les entrées actives et vérifiées sont visibles par les agriculteurs. Les entrées exemples / brouillons sont exclues de l\'export CSV.', sw: 'Ni vipengee hai na vilivyothibitishwa pekee vinaonyeshwa kwa wakulima. Vipengee vya sampuli / rasimu havijajumuishwa kwenye uhamishaji wa CSV.', ha: 'Mai aiki kawai + tabbatattun shigarwa ne ke bayyana ga manoma. An ware shigarwar samfuri / daftari daga fitar da CSV.', tw: 'Nea ɛrekɔ so + nea wɔahwehwɛ mu nko ara na ɛda adi ma akuafoɔ. CSV no nkata samfuri / daakye nkrataa so.', hi: 'केवल सक्रिय + सत्यापित प्रविष्टियाँ किसानों को दिखाई जाती हैं। नमूना / मसौदा प्रविष्टियाँ CSV निर्यात में शामिल नहीं हैं।' },
  'funding.whyMatched':         { en: 'Why this matches',    fr: 'Pourquoi cette correspondance', sw: 'Kwa nini hii inalingana', ha: 'Me yasa wannan ya dace', tw: 'Adɛn enti na yei fata', hi: 'यह क्यों मेल खाता है' },

  // ─── Funding Apply + Request Help (v3 merge) ──────────────
  // Trust rules per spec § 12: never "guaranteed", "approved",
  // or "you qualify" — always "may qualify", "check
  // requirements", "apply through official source".
  'funding.viewDetails':           { en: 'View Details',         fr: 'Voir les détails',       sw: 'Tazama Maelezo',        ha: 'Duba Cikakken Bayani',   tw: 'Hwɛ Nsɛm No',           hi: 'विवरण देखें' },
  ...
  'funding.name':                  { en: 'Your name',            fr: 'Votre nom',              sw: 'Jina lako',             ha: 'Sunanka',                tw: 'Wo din',                hi: 'आपका नाम' },
  'funding.phone':                 { en: 'Phone (with country code)', fr: 'Téléphone (avec indicatif pays)', sw: 'Simu (na msimbo wa nchi)', ha: 'Wayar tarho (da lambar ƙasa)', tw: 'Phone (ne ɔman koodu)', hi: 'फोन (देश कोड सहित)' },
  'funding.message':               { en: 'What kind of help do you need? (optional)', fr: 'De quel type d\'aide avez-vous besoin ? (optionnel)', sw: 'Unahitaji msaada wa aina gani? (hiari)', ha: 'Wace irin taimako kake bukata? (zaɓi)', tw: 'Mmoa bɛn na wohia? (a ɛhia)', hi: 'आपको किस प्रकार की सहायता चाहिए? (वैकल्पिक)' },
  'funding.sendRequest':           { en: 'Send request',         fr: 'Envoyer la demande',     sw: 'Tuma ombi',             ha: 'Aika buƙata',            tw: 'Kɔto wo nsɛm',          hi: 'अनुरोध भेजें' },
  'funding.requestSent':           { en: 'Request sent. A program officer or support team may follow up.', fr: 'Demande envoyée. Un agent de programme ou une équipe de soutien pourra vous recontacter.', sw: 'Ombi limetumwa. Afisa wa programu au timu ya msaada inaweza kufuatilia.', ha: 'An aika buƙata. Wani jami\'in shirin ko ƙungiyar tallafi na iya bibiya.', tw: 'Wɔde wo nsɛm akɔto. Nhyehyɛeɛ panyin anaa boafoɔ kuw bɛtumi adi akyi.', hi: 'अनुरोध भेज दिया गया। एक कार्यक्रम अधिकारी या समर्थन टीम संपर्क कर सकती है।' },
  'funding.markedApplied':         { en: 'Marked as applied. Keep checking the source for updates.', fr: 'Marqué comme postulé. Continuez à consulter la source pour des mises à jour.', sw: 'Imewekewa alama ya kuomba. Endelea kuangalia chanzo kwa masasisho.', ha: 'An sanya alama a matsayin neman. Ci gaba da duba tushe don sabuntawa.', tw: 'Wɔayɛ no sɛ deɛ wapɔ. Kɔ so hwɛ nipa a wɔde maaeɛ no fa nsɛm a ɛrebrɛ ho.', hi: 'आवेदन के रूप में चिह्नित। अपडेट के लिए स्रोत की जाँच करते रहें।' },
  'funding.checkSource':           { en: 'Apply through the official source. Marking as applied here helps you self-track only — Farroway does not approve or guarantee funding.', fr: 'Postulez via la source officielle. Marquer comme postulé ici vous aide à suivre votre propre progression — Farroway n\'approuve ni ne garantit aucun financement.', sw: 'Omba kupitia chanzo rasmi. Kuweka alama ya kuomba hapa kunakusaidia kufuatilia mwenyewe tu — Farroway haiidhinishi wala kuhakikisha ufadhili.', ha: 'Nemi ta hanyar tushe na hukuma. Sanya alama a matsayin neman a nan na taimaka muku bin diddigi kawai — Farroway baya amincewa ko bada tabbacin tallafi.', tw: 'Pɔ fa nipa a wɔde maaeɛ no so. Sɛ woyɛ no sɛ deɛ wapɔ wɔ ha a, ɛboa wo ara — Farroway nnye sika a tom anaa nhyɛ den.', hi: 'आधिकारिक स्रोत के माध्यम से आवेदन करें। यहाँ आवेदित के रूप में चिह्नित करना केवल आपकी स्वयं की ट्रैकिंग में मदद करता है — Farroway फंडिंग को मंज़ूर या गारंटी नहीं देता।' },
  'funding.applicationInterest':   { en: 'Application Interest', fr: 'Intérêt pour la demande', sw: 'Maslahi ya Maombi',    ha: 'Sha\'awar Neman',         tw: 'Pɔ Anidasoɔ',           hi: 'आवेदन में रुचि' },
  'funding.assistanceRequested':   { en: 'Help requested',       fr: 'Aide demandée',          sw: 'Msaada umeombwa',       ha: 'An nemi taimako',        tw: 'Wɔabisa mmoa',          hi: 'सहायता का अनुरोध किया' },
  'funding.applied':               { en: 'Applied (self-report)', fr: 'Postulé (auto-déclaré)', sw: 'Imeombwa (kujitathmini)', ha: 'An nema (bayar da kai)', tw: 'Wapɔ (ɔno ankasa kasa)', hi: 'आवेदन किया (स्व-रिपोर्ट)' },
  'funding.interested':            { en: 'Interested',           fr: 'Intéressé',              sw: 'Ana hamu',              ha: 'Mai sha\'awa',           tw: 'Anidasoɔ',              hi: 'रुचि' },
  'funding.contacted':             { en: 'Contacted',            fr: 'Contacté',               sw: 'Amewasiliana',          ha: 'An tuntuɓa',             tw: 'Wɔafrɛ',                hi: 'संपर्क किया' },
  'funding.markContacted':         { en: 'Mark contacted',       fr: 'Marquer comme contacté', sw: 'Weka alama amewasiliana', ha: 'Sanya alama an tuntuɓa', tw: 'Yɛ no sɛ wɔafrɛ',       hi: 'संपर्क किया चिह्नित करें' },
  'funding.tabCatalog':            { en: 'Catalog',              fr: 'Catalogue',              sw: 'Katalogi',              ha: 'Kasidi',                 tw: 'Nhyehyɛeɛ Nyinaa',      hi: 'कैटलॉग' },
  ...
  'verification.addLocation':   { en: 'Add location to this task (optional)', fr: 'Ajouter la localisation à cette tâche (optionnel)', sw: 'Ongeza mahali kwenye kazi hii (hiari)', ha: 'Ƙara wuri ga wannan aiki (zaɓi)', tw: 'Fa baabi ka adwuma yi ho (a ɛhia)', hi: 'इस कार्य में स्थान जोड़ें (वैकल्पिक)' },
  'verification.checkingLocation':{ en: 'Checking location…',  fr: 'Vérification de la localisation…', sw: 'Inakagua mahali…', ha: 'Ana duba wuri…',          tw: 'Yɛrehwehwɛ baabi…',  hi: 'स्थान जाँच रहे हैं…' },
  'verification.locationDenied':{ en: 'Location not available — that\u2019s OK', fr: 'Localisation non disponible — pas de souci', sw: 'Mahali hapapatikani — ni sawa', ha: 'Wuri ba ya samuwa — ba damuwa', tw: 'Baabi nni hɔ — ɛnyɛ asɛm',           hi: 'स्थान उपलब्ध नहीं — कोई बात नहीं' },

  // ─── NGO Program Distribution (v3 merge) ───────────────────
  'program.adminTitle':       { en: 'Send a program to farmers',     fr: 'Envoyer un programme aux agriculteurs', sw: 'Tuma programu kwa wakulima',     ha: 'Aika shiri ga manoma',          tw: 'Kɔto nhyehyɛeɛ ma akuafoɔ',  hi: 'किसानों को कार्यक्रम भेजें' },
  'program.adminLead':        { en: 'Compose a short message and choose which farmers receive it. Empty crops + regions = send to everyone.', fr: 'Rédigez un court message et choisissez les agriculteurs qui le recevront. Cultures + régions vides = envoyer à tout le monde.', sw: 'Tunga ujumbe mfupi na uchague wakulima wapi watapokea. Mazao + maeneo tupu = tuma kwa kila mtu.', ha: 'Rubuta gajeren saƙo kuma zaɓi waɗanne manoma za su karɓa. Amfani + yankuna fanko = aikawa kowa.', tw: 'Twerɛ nsɛm tiawa na yi akuafoɔ a wɔbɛnya bi. Aduane ne mantam mu da hɔ = kɔto ma obiara.', hi: 'एक छोटा संदेश लिखें और चुनें कि कौन से किसान इसे प्राप्त करेंगे। खाली फसलें + क्षेत्र = सभी को भेजें।' },
  'program.title':            { en: 'Title',          fr: 'Titre',         sw: 'Kichwa',         ha: 'Take',           tw: 'Tikya',         hi: 'शीर्षक' },
  'program.type':             { en: 'Type',           fr: 'Type',          sw: 'Aina',           ha: 'Nau\'i',         tw: 'Esuo',          hi: 'प्रकार' },
  'program.message':          { en: 'Message (short, plain language)', fr: 'Message (court, langage simple)', sw: 'Ujumbe (mfupi, lugha rahisi)', ha: 'Saƙo (gajere, sauƙin harshe)', tw: 'Nsɛm (tiawa, kasa pa)', hi: 'संदेश (छोटा, सरल भाषा)' },
  'program.crops':            { en: 'Target crops (comma-separated, blank = any)', fr: 'Cultures cibles (séparées par des virgules, vide = toutes)', sw: 'Mazao lengwa (yaliyotenganishwa kwa koma, tupu = yoyote)', ha: 'Amfani da aka nufa (rabe da waƙafi, fanko = kowanne)', tw: 'Aduane a yɛrekɔto ma (komma na ɛkyekye mu, hokwan biara nni hɔ = biara)', hi: 'लक्षित फसलें (अल्पविराम से अलग, खाली = कोई भी)' },
  'program.regions':          { en: 'Target regions (comma-separated, blank = any)', fr: 'Régions cibles (séparées par des virgules, vide = toutes)', sw: 'Maeneo lengwa (yaliyotenganishwa kwa koma, tupu = yoyote)', ha: 'Yankunan da aka nufa (rabe da waƙafi, fanko = kowanne)', tw: 'Mantam a yɛrekɔto ma (komma na ɛkyekye mu, hokwan biara nni hɔ = biara)', hi: 'लक्षित क्षेत्र (अल्पविराम से अलग, खाली = कोई भी)' },
  'program.deadline':         { en: 'Deadline (optional)', fr: 'Date limite (optionnel)', sw: 'Tarehe ya mwisho (hiari)', ha: 'Ƙarshen lokaci (zaɓi)', tw: 'Da Korkorɛɛ (a ɛhia)',    hi: 'समय सीमा (वैकल्पिक)' },
  'program.send':             { en: 'Send Program',  fr: 'Envoyer le programme', sw: 'Tuma Programu',  ha: 'Aika Shiri',         tw: 'Kɔto Nhyehyɛeɛ',    hi: 'कार्यक्रम भेजें' },
  'program.sending':          { en: 'Sending…',      fr: 'Envoi…',         sw: 'Inatuma…',       ha: 'Ana aikawa…',          tw: 'Yɛrekɔto…',         hi: 'भेज रहे हैं…' },
  'program.sent':             { en: 'Program sent.', fr: 'Programme envoyé.', sw: 'Programu imetumwa.', ha: 'An aika shirin.',  tw: 'Wɔakɔto nhyehyɛeɛ no.', hi: 'कार्यक्रम भेज दिया गया।' },
  'program.previewMatchHead': { en: 'Matches',       fr: 'Correspondances', sw: 'Inalingana',     ha: 'Daidaitawa',           tw: 'Ahyia',             hi: 'मेल' },
  'program.previewOneFarmer': { en: 'farmer',        fr: 'agriculteur',    sw: 'mkulima',        ha: 'manomi',               tw: 'okuafoɔ',           hi: 'किसान' },
  'program.previewManyFarmers':{ en: 'farmers',      fr: 'agriculteurs',   sw: 'wakulima',       ha: 'manoma',               tw: 'akuafoɔ',           hi: 'किसान' },
  'program.previewKnown':     { en: 'known',         fr: 'connus',         sw: 'wanaojulikana',  ha: 'sananne',              tw: 'a yɛnim',           hi: 'ज्ञात' },
  'program.previewLoading':   { en: 'Loading farmer list…', fr: 'Chargement de la liste des agriculteurs…', sw: 'Inapakia orodha ya wakulima…', ha: 'Ana lodin jerin manoma…', tw: 'Yɛregye akuafoɔ jerin no…', hi: 'किसान सूची लोड हो रही है…' },
  'program.previewNoFarmers': { en: 'Farmer list unavailable. The program will save, but no deliveries will be created until the list loads.', fr: 'Liste des agriculteurs indisponible. Le programme sera enregistré, mais aucune livraison ne sera créée tant que la liste ne sera pas chargée.', sw: 'Orodha ya wakulima haipatikani. Programu itahifadhiwa, lakini hakuna utoaji utakaoundwa hadi orodha ipakie.', ha: 'Jerin manoma ba ya samuwa. Shirin zai ajiye, amma ba za a ƙirƙiri wani isarwa ba har sai jerin ya loda.', tw: 'Akuafoɔ jerin nni hɔ. Nhyehyɛeɛ no bɛhyɛ, nanso wɔrenyɛ adwuma biara kosi sɛ jerin no bɛba.', hi: 'किसान सूची अनुपलब्ध है। कार्यक्रम सहेजा जाएगा, लेकिन सूची लोड होने तक कोई डिलीवरी नहीं बनाई जाएगी।' },
  'program.recent':           { en: 'Recent programs',     fr: 'Programmes récents',    sw: 'Programu za hivi karibuni', ha: 'Shirye-shiryen kwanan nan', tw: 'Nhyehyɛeɛ a aba seesei ara', hi: 'हाल के कार्यक्रम' },
  'program.illDoThis':        { en: 'I’ll do this',        fr: 'Je vais le faire',      sw: 'Nitafanya hivi',        ha: 'Zan yi wannan',         tw: 'Mɛyɛ',              hi: 'मैं यह करूँगा' },
  'program.thanks':           { en: 'Thank you. The program team can see you’re acting on this.', fr: 'Merci. L\'équipe du programme peut voir que vous agissez.', sw: 'Asante. Timu ya programu inaweza kuona unachukua hatua.', ha: 'Na gode. Ƙungiyar shirin za ta iya ganin kana aiki kan wannan.', tw: 'Meda wo ase. Nhyehyɛeɛ kuw no tumi hu sɛ woreyɛ ho adwuma.', hi: 'धन्यवाद। कार्यक्रम टीम देख सकती है कि आप इस पर काम कर रहे हैं।' },
  'program.untilDeadline':    { en: 'Until',               fr: 'Jusqu\'au',             sw: 'Hadi',                  ha: 'Har',                   tw: 'Kosi',              hi: 'तक' },
  'program.empty':            { en: 'No programs sent yet.', fr: 'Aucun programme envoyé pour l\'instant.', sw: 'Hakuna programu zilizotumwa bado.', ha: 'Babu shirye-shiryen da aka aika tukuna.', tw: 'Wɔnkɔto nhyehyɛeɛ biara ɛnnɛ.', hi: 'अभी तक कोई कार्यक्रम नहीं भेजा गया।' },
  'program.emptyHint':        { en: 'Create a program to send a short message to a group of farmers — by crop, region, or both.', fr: 'Créez un programme pour envoyer un court message à un groupe d\'agriculteurs — par culture, région, ou les deux.', sw: 'Tengeneza programu ili kutuma ujumbe mfupi kwa kundi la wakulima — kwa zao, eneo, au yote mawili.', ha: 'Ƙirƙiri shiri don aika gajeren saƙo zuwa rukunin manoma — ta amfani, yanki, ko duka biyu.', tw: 'Yɛ nhyehyɛeɛ na fa kɔto nsɛm tiawa ma akuafoɔ kuw — gyina aduane, mantam, anaa nyinaa so.', hi: 'किसानों के समूह को छोटा संदेश भेजने के लिए कार्यक्रम बनाएँ — फसल, क्षेत्र, या दोनों के अनुसार।' },
  'program.newProgram':       { en: 'New program',         fr: 'Nouveau programme',     sw: 'Programu mpya',         ha: 'Sabon shiri',           tw: 'Nhyehyɛeɛ foforɔ',  hi: 'नया कार्यक्रम' },
  'program.ngoPanelLabel':    { en: 'Program performance', fr: 'Performance du programme', sw: 'Utendaji wa programu', ha: 'Aikin shirin',        tw: 'Nhyehyɛeɛ ho adwuma', hi: 'कार्यक्रम प्रदर्शन' },
  'program.ngoPanelTitle':    { en: 'How farmers are responding to your programs', fr: 'Comment les agriculteurs répondent à vos programmes', sw: 'Jinsi wakulima wanavyojibu programu zako', ha: 'Yadda manoma ke amsa shirye-shiryenku', tw: 'Sɛnea akuafoɔ regye wo nhyehyɛeɛ no so', hi: 'किसान आपके कार्यक्रमों पर कैसे प्रतिक्रिया दे रहे हैं' },
  'program.colName':          { en: 'Program',       fr: 'Programme',     sw: 'Programu',       ha: 'Shiri',          tw: 'Nhyehyɛeɛ',         hi: 'कार्यक्रम' },
  'program.colSent':          { en: 'Sent',          fr: 'Envoyé',        sw: 'Imetumwa',       ha: 'An aika',        tw: 'Wɔakɔto',           hi: 'भेजा गया' },
  'program.colOpened':        { en: 'Opened',        fr: 'Ouvert',        sw: 'Imefunguliwa',   ha: 'An buɗe',        tw: 'Wɔabue',            hi: 'खोला गया' },
  'program.colActed':         { en: 'Acted',         fr: 'A agi',         sw: 'Imechukua hatua', ha: 'An ɗauki mataki', tw: 'Wɔayɛ ho adwuma', hi: 'कार्य किया' },
  'program.colRate':          { en: 'Acted %',       fr: 'Action %',      sw: 'Hatua %',        ha: 'Mataki %',       tw: 'Adwuma %',          hi: 'कार्य %' },
  'program.honesty':          { en: 'Acted % = farmers who tapped the program’s primary action. The dashboard\'s only metric — never the only signal.', fr: 'Action % = agriculteurs qui ont tapé sur l\'action principale du programme. Seule mesure du tableau de bord — jamais le seul signal.', sw: 'Hatua % = wakulima walioweka kidole kwenye hatua kuu ya programu. Kipimo pekee cha dashibodi — kamwe ishara pekee.', ha: 'Mataki % = manoma waɗanda suka taɓa babban aikin shirin. Tushen ma\'auni na dashboard kawai — ba alama kawai ba.', tw: 'Adwuma % = akuafoɔ a wɔde wɔn nsa kaa nhyehyɛeɛ no adwuma a edi kan no. Ɛyɛ dashboard no susukoraa baako pɛ — ɛnyɛ nsɛnkyerɛnne baako pɛ.', hi: 'कार्य % = किसान जिन्होंने कार्यक्रम की प्राथमिक क्रिया टैप की। डैशबोर्ड का एकमात्र मीट्रिक — कभी एकमात्र संकेत नहीं।' },
  'program.farmsLoadError':   { en: 'Could not fetch the farmer list. New programs save, but deliveries are skipped until the list loads.', fr: 'Impossible de récupérer la liste des agriculteurs. Les nouveaux programmes sont enregistrés, mais les livraisons sont ignorées tant que la liste ne se charge pas.', sw: 'Haikuweza kupata orodha ya wakulima. Programu mpya zinahifadhiwa, lakini utoaji unarukwa hadi orodha ipakie.', ha: 'Ba a iya samun jerin manoma ba. Sabbin shirye-shirye suna ajiye, amma ana tsallake isarwa har sai jerin ya loda.', tw: 'Yentumi annya akuafoɔ jerin no. Nhyehyɛeɛ foforo no hyɛ, nanso yɛrenyɛ adwuma biara kosi sɛ jerin no bɛba.', hi: 'किसान सूची प्राप्त नहीं हो सकी। नए कार्यक्रम सहेजे जाते हैं, लेकिन सूची लोड होने तक डिलीवरी छोड़ दी जाती है।' },
  'program.backToFunding':    { en: 'Manage funding',  fr: 'Gérer le financement', sw: 'Simamia ufadhili', ha: 'Gudanar da tallafi', tw: 'Hwɛ sika so',     hi: 'फंडिंग प्रबंधित करें' },
  ...
  // ─── Field Agent Mode (v3 merge) ───────────────────────────
  'agent.dashboardTitle': { en: 'Field agent',                fr: 'Agent de terrain',     sw: 'Wakala wa shamba',      ha: 'Wakili a fili',          tw: 'Asaase mu boafoɔ',       hi: 'फील्ड एजेंट' },
  'agent.dashboardLead':  { en: 'Add farmers in the field. Their details stay on this phone until your network comes back.', fr: 'Ajoutez des agriculteurs sur le terrain. Leurs informations restent sur ce téléphone jusqu\'au retour du réseau.', sw: 'Ongeza wakulima shambani. Maelezo yao yanabaki kwenye simu hii hadi mtandao wako urudi.', ha: 'Ƙara manoma a fili. Bayanansu su tsaya akan wannan wayar har sai cibiyar sadarwarka ta dawo.', tw: 'Fa akuafoɔ ka ho wɔ kuoyɛ mu. Wɔn nsɛm bɛtena phone yi so kosi sɛ network bɛsan aba.', hi: 'मैदान में किसानों को जोड़ें। उनकी जानकारी आपके नेटवर्क के वापस आने तक इस फोन पर रहती है।' },
  'agent.tabFarmers':     { en: 'My Farmers',                 fr: 'Mes agriculteurs',     sw: 'Wakulima Wangu',        ha: 'Manomana',                tw: 'M\'akuafoɔ',             hi: 'मेरे किसान' },
  'agent.tabAdd':         { en: 'Add Farmer',                 fr: 'Ajouter un agriculteur', sw: 'Ongeza Mkulima',     ha: 'Ƙara Manomi',             tw: 'Fa Okuafoɔ Ka Ho',       hi: 'किसान जोड़ें' },
  'agent.tabActivity':    { en: 'Activity Log',               fr: 'Journal d\'activité',  sw: 'Logi ya Shughuli',      ha: 'Tarihin Ayyuka',          tw: 'Adwuma Nkrataa',         hi: 'गतिविधि लॉग' },
  'agent.online':         { en: 'Online — changes sync automatically', fr: 'En ligne — synchronisation automatique', sw: 'Mtandaoni — mabadiliko yanaweka kwa otomatiki', ha: 'A kan layi — sauye-sauye suna daidaita ta atomatik', tw: 'Mfa wo ho hyɛ Internet so — nsakraeɛ no kɔ so ankasa', hi: 'ऑनलाइन — परिवर्तन स्वचालित रूप से सिंक होते हैं' },
  'agent.offline':        { en: 'Offline — saving locally',   fr: 'Hors ligne — enregistrement local', sw: 'Nje ya mtandao — inahifadhi ndani', ha: 'Babu hanya — yana adana cikin gida', tw: 'Internet nni hɔ — yɛrekora yi wɔ ha', hi: 'ऑफ़लाइन — स्थानीय रूप से सहेज रहे हैं' },
  'agent.allSynced':      { en: 'All caught up',              fr: 'Tout est à jour',      sw: 'Vyote vimekamilika',    ha: 'Komai ya cika',           tw: 'Biribiara abedu',        hi: 'सब अद्यतन है' },
  'agent.pending':        { en: 'pending sync',               fr: 'en attente',           sw: 'inasubiri',             ha: 'jiran daidaita',          tw: 'ɛrebɛkɔ',                 hi: 'सिंक लंबित' },
  'agent.synced':         { en: 'synced',                     fr: 'synchronisé',          sw: 'imesawazishwa',         ha: 'an daidaita',             tw: 'wɔde akɔ',                hi: 'सिंक' },
  'agent.syncNow':        { en: 'Sync now',                   fr: 'Synchroniser',         sw: 'Sawazisha sasa',        ha: 'Daidaita yanzu',          tw: 'Daidaita seesei',         hi: 'अभी सिंक' },
  'agent.statFarmers':    { en: 'Farmers',                    fr: 'Agriculteurs',         sw: 'Wakulima',              ha: 'Manoma',                  tw: 'Akuafoɔ',                 hi: 'किसान' },
  'agent.statVisits':     { en: 'Visits logged',              fr: 'Visites enregistrées', sw: 'Ziara zilizorekodiwa',  ha: 'Ziyarce-ziyarcen da aka rubuta', tw: 'Nsra a wɔakyerɛ',  hi: 'दर्ज की गई यात्राएँ' },
  'agent.statPending':    { en: 'Pending sync',               fr: 'En attente de sync',   sw: 'Inasubiri',             ha: 'Jiran daidaita',          tw: 'Ɛrebɛkɔ',                 hi: 'सिंक लंबित' },
  'agent.addFarmer':      { en: 'Add a farmer',               fr: 'Ajouter un agriculteur', sw: 'Ongeza mkulima',     ha: 'Ƙara manomi',             tw: 'Fa okuafoɔ ka ho',       hi: 'किसान जोड़ें' },
  'agent.farmerName':     { en: 'Name',                       fr: 'Nom',                  sw: 'Jina',                  ha: 'Suna',                    tw: 'Edin',                   hi: 'नाम' },
  'agent.farmerPhone':    { en: 'Phone (with country code)',  fr: 'Téléphone (avec indicatif pays)', sw: 'Simu (na msimbo wa nchi)', ha: 'Wayar tarho (da lambar ƙasa)', tw: 'Phone (ne ɔman koodu)', hi: 'फोन (देश कोड सहित)' },
  'agent.crop':           { en: 'Crop',                       fr: 'Culture',              sw: 'Zao',                   ha: 'Amfani',                  tw: 'Aduane',                  hi: 'फसल' },
  'agent.farmSize':       { en: 'Farm size (ha)',             fr: 'Taille de la ferme (ha)', sw: 'Ukubwa wa shamba (ha)', ha: 'Girman gona (ha)',     tw: 'Afuo no kɛse (ha)',       hi: 'खेत का आकार (हे.)' },
  'agent.region':         { en: 'Region',                     fr: 'Région',               sw: 'Eneo',                  ha: 'Yanki',                   tw: 'Mantam',                  hi: 'क्षेत्र' },
  'agent.haShort':        { en: 'ha',                         fr: 'ha',                   sw: 'ha',                    ha: 'ha',                      tw: 'ha',                      hi: 'हे.' },
  'agent.gpsBusy':        { en: 'Reading location\u2026',     fr: 'Lecture de la localisation\u2026', sw: 'Inasoma mahali\u2026',  ha: 'Ana karanta wuri\u2026',     tw: 'Yɛrekenkan baabi\u2026',  hi: 'स्थान पढ़ रहे हैं\u2026' },
  'agent.gpsCaptured':    { en: 'Location captured',          fr: 'Localisation capturée', sw: 'Mahali pamekamatwa',   ha: 'An kama wuri',            tw: 'Wɔakora baabi',          hi: 'स्थान कैप्चर किया गया' },
  'agent.gpsDenied':      { en: 'Location not available — that\u2019s OK', fr: 'Localisation non disponible — pas de souci', sw: 'Mahali hapapatikani — ni sawa', ha: 'Wuri ba ya samuwa — ba damuwa', tw: 'Baabi nni hɔ — ɛnyɛ asɛm', hi: 'स्थान उपलब्ध नहीं — कोई बात नहीं' },
  'agent.gpsIdle':        { en: 'Location pending\u2026',     fr: 'Localisation en attente\u2026', sw: 'Mahali panasubiri\u2026', ha: 'Wuri yana jira\u2026',  tw: 'Baabi rebɛba\u2026',     hi: 'स्थान लंबित\u2026' },
  'agent.saveFarmer':     { en: 'Save Farmer',                fr: 'Enregistrer l\'agriculteur', sw: 'Hifadhi Mkulima', ha: 'Adana Manomi',         tw: 'Kora Okuafoɔ',           hi: 'किसान सहेजें' },
  'agent.saving':         { en: 'Saving\u2026',               fr: 'Enregistrement\u2026', sw: 'Inahifadhi\u2026',      ha: 'Ana adana\u2026',         tw: 'Yɛrekora\u2026',          hi: 'सहेज रहे हैं\u2026' },
  'agent.farmerSaved':    { en: 'Farmer saved. Will sync when online.', fr: 'Agriculteur enregistré. Synchronisation dès que vous serez en ligne.', sw: 'Mkulima amehifadhiwa. Atasawazisha akiwa mtandaoni.', ha: 'An adana manomi. Zai daidaita lokacin da kake kan layi.', tw: 'Wɔakora okuafoɔ no. Ɛbɛkɔ Internet so bere a wo phone bɛkɔ Internet so.', hi: 'किसान सहेजा गया। ऑनलाइन होने पर सिंक होगा।' },
  'agent.privacyNote':    { en: 'Farmer details stay on this device until your phone is online. They sync to your organisation\u2019s account.', fr: 'Les détails de l\'agriculteur restent sur cet appareil jusqu\'à ce que votre téléphone soit en ligne. Ils se synchronisent avec le compte de votre organisation.', sw: 'Maelezo ya mkulima yanabaki kwenye kifaa hiki hadi simu yako iwe mtandaoni. Yatasawazishwa kwenye akaunti ya shirika lako.', ha: 'Bayanan manomi suna tsaya akan wannan na\'urar har sai wayarka ta zama akan layi. Suna daidaitawa zuwa asusun kungiyarka.', tw: 'Okuafoɔ nsɛm bɛtena ha kosi sɛ wo phone bɛkɔ Internet so. Ɛbɛkɔ wo organization akontaa so.', hi: 'किसान का विवरण आपके फोन के ऑनलाइन होने तक इस डिवाइस पर रहता है। वे आपके संगठन के खाते में सिंक होते हैं।' },
  'agent.myFarmersTitle': { en: 'My farmers',                 fr: 'Mes agriculteurs',     sw: 'Wakulima wangu',        ha: 'Manomana',                tw: 'M\'akuafoɔ',             hi: 'मेरे किसान' },
  'agent.noFarmers':      { en: 'You haven\u2019t added any farmers yet.', fr: 'Vous n\'avez encore ajouté aucun agriculteur.', sw: 'Bado hujaongeza wakulima wowote.', ha: 'Har yanzu ba ka ƙara wani manomi ba.', tw: 'Wonkaa okuafoɔ biara nkaa ho ɛnnɛ.', hi: 'आपने अभी तक कोई किसान नहीं जोड़ा है।' },
  'agent.noFarmersHint':  { en: 'Tap "Add Farmer" to register your first one. Works offline.', fr: 'Appuyez sur "Ajouter un agriculteur" pour enregistrer le premier. Fonctionne hors ligne.', sw: 'Bonyeza "Ongeza Mkulima" kusajili wa kwanza. Inafanya kazi nje ya mtandao.', ha: 'Latsa "Ƙara Manomi" don rajistar farkonka. Yana aiki ba tare da intanet ba.', tw: 'Mia "Fa Okuafoɔ Ka Ho" na fa wo a edi kan no kyerɛw. Ɛyɛ adwuma a Internet nni hɔ.', hi: 'अपना पहला किसान पंजीकृत करने के लिए "किसान जोड़ें" टैप करें। ऑफ़लाइन काम करता है।' },
  'agent.unnamed':        { en: 'Unnamed farmer',             fr: 'Agriculteur sans nom', sw: 'Mkulima asiye na jina', ha: 'Manomi mara suna',        tw: 'Okuafoɔ a ɔnni din',      hi: 'अनाम किसान' },
  'agent.cropUnknown':    { en: 'crop unknown',               fr: 'culture inconnue',     sw: 'zao halijulikani',      ha: 'amfani ba a sani ba',     tw: 'aduane a yɛnnim',         hi: 'फसल अज्ञात' },
  'agent.logVisit':       { en: 'Log visit',                  fr: 'Enregistrer la visite', sw: 'Rekodi ziara',         ha: 'Rikodin ziyara',          tw: 'Kyerɛw nsra',             hi: 'यात्रा दर्ज करें' },
  'agent.activityTitle':  { en: 'Activity log',               fr: 'Journal d\'activité',  sw: 'Logi ya shughuli',      ha: 'Tarihin ayyuka',          tw: 'Adwuma nkrataa',         hi: 'गतिविधि लॉग' },
  'agent.noActivity':     { en: 'No activity yet on this device.', fr: 'Aucune activité sur cet appareil pour le moment.', sw: 'Hakuna shughuli bado kwenye kifaa hiki.', ha: 'Babu ayyuka tukuna a wannan na\'urar.', tw: 'Adwuma biara nyɛ wɔ na\'ura yi so ɛnnɛ.', hi: 'इस डिवाइस पर अभी तक कोई गतिविधि नहीं।' },
  'agent.noActivityHint': { en: 'Adding a farmer or logging a visit will appear here.', fr: 'L\'ajout d\'un agriculteur ou l\'enregistrement d\'une visite apparaîtra ici.', sw: 'Kuongeza mkulima au kurekodi ziara kutaonekana hapa.', ha: 'Ƙara manomi ko rikodin ziyara zai bayyana a nan.', tw: 'Sɛ wode okuafoɔ ka ho anaa wokyerɛw nsra a, ɛbɛda adi wɔ ha.', hi: 'किसान जोड़ना या यात्रा दर्ज करना यहाँ दिखाई देगा।' },
  'agent.attempts':       { en: 'attempts',                   fr: 'tentatives',           sw: 'majaribio',             ha: 'yunkuri',                 tw: 'mmɔden',                  hi: 'प्रयास' },
