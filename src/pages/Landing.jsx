...
// Real Farroway shield \u2014 the canonical brand asset, baked from
// /public/icons/logo-premium.jpg via scripts/bake-brand-mark.mjs
// so the bytes ship inside the bundle itself. No network
// request, no service-worker cache to miss, no 404 race.
// Re-runs of the bake script automatically refresh this when
// the brand team drops a new master at /public/icons/logo-
// premium.{svg,png,jpg}.
import { FARROWAY_MARK_DATA_URL as FARROWAY_LOGO_DATA_URL } from '../brand/farrowayMarkDataUrl.js';
