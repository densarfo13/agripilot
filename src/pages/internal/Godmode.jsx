...
const PROBES = [
  ...
  ['__launchUXHealth',      'Launch UX'],
  ['__activityNavHealth',    'Activity Nav'],
  ['__ngoImportTruthHealth', 'NGO Import Truth'],
  ['__ngoMetricsHealth',     'NGO Metrics'],
  ['__i18nGrowerHealth',     'Grower i18n'],
  ...
  ['__qaReadiness',        'QA Readiness'],
  ['__consentHealth',      'Consent'],
  ['__retentionHealth',    'Retention Policy'],
